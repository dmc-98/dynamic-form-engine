...
- [ ] Configure repo description, homepage, topics, and Discussions with `pnpm github:configure`.
- [ ] Pin or open a Showcase / Feedback discussion after Discussions are enabled.
...
- [ ] Launch post draft is ready in `marketing/launch-kit.md`.
...
- [ ] Record star count and top feedback in `GROWTH_RELEASE_PLAN.md` or the launch tracker.
