...
// ─── AI Form Builder (provider-agnostic, review-first) ────────────────────────
// Re-exported so consumers can import the builder from '@dmc--98/dfe-core'.
export { createAiFormBuilder } from './ai/builder'
export type {
  AiProvider,
  AiFormBuilder,
  AiFormBuilderOptions,
  GenerateResult,
  RefineResult,
} from './ai/builder'
export type { FormConfig as AiFormConfig } from './ai/builder'
