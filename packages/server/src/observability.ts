function randomHex(length: number) {
  // NOTE: Trace/span IDs use Math.random and are NOT cryptographically secure.
  // They only need to be collision-resistant enough for correlation, not
  // unguessable. Do not use these IDs for any security-sensitive purpose.
  let value = ''
