...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Try Playground
      link: /packages/playground
    - theme: alt
      text: View on GitHub
      link: https://github.com/dmc-98/dynamic-form-engine
...
The stable Playground is the fastest way to evaluate the authoring experience before wiring DFE into an app: [open the Playground package guide](/packages/playground).
