...
For the May 2026 launch plan, deploy the public Playground as a static SPA first and keep backend-backed collaboration examples separate.

Recommended default:

- Cloudflare Pages for the public Playground.
- GitHub Pages for docs.
- A serverless runtime for API or collaboration demos.

GitHub Pages can serve a static Playground preview, but it is not the right place to market backend or collaboration flows.
