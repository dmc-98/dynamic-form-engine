  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Playground', link: '/packages/playground' },
      {
        text: 'v0.1.0',
        items: [
          { text: 'Changelog', link: 'https://github.com/dmc-98/dynamic-form-engine/blob/main/CHANGELOG.md' },
          { text: 'Contributing', link: 'https://github.com/dmc-98/dynamic-form-engine/blob/main/CONTRIBUTING.md' },
        ],
      },
    ],
    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          text: 'Roadmap',
          items: [
            { text: 'AI Form Builder', link: '/guide/ai-form-builder' },
          ],
        },
      ],
      '/packages/': [
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/dmc-98/dynamic-form-engine' },
    ],
    ...
    editLink: {
      pattern: 'https://github.com/dmc-98/dynamic-form-engine/edit/main/docs/:path',
